...
namespace ExciteOMeter
{
    ...
    public static class EoM_Events
    {
        ...
        public delegate void DataFloat(ExciteOMeter.DataType type, DateTime timestamp, float value);
        public static event DataFloat OnDataReceived;
        public static void Send_OnDataReceived(ExciteOMeter.DataType dataType, DateTime timestamp, float value)
        {
        ...
        public delegate void DataFloatArray(ExciteOMeter.DataType type, DateTime timestamp, float[] value);
        public static event DataFloatArray OnDataArrayReceived;
        public static void Send_OnDataArrayReceived(ExciteOMeter.DataType dataType, DateTime timestamp, float[] array)
        {
        ...
        public delegate void DataString(ExciteOMeter.DataType type, DateTime timestamp, string message, MarkerLabel label);
        public static event DataString OnStringReceived;

        public static void Send_OnStringReceived(ExciteOMeter.DataType type, DateTime timestamp, string message, MarkerLabel label = MarkerLabel.CUSTOM_MARKER)
        {
