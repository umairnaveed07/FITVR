...
namespace ExciteOMeter
{
    public abstract class EoM_Base_FeatureCalculation : MonoBehaviour
    {
        ...
        private void AddToBuffer(ExciteOMeter.DataType type, DateTime timestamp, float value)
        {
        ...
        private void AddToBufferArray(ExciteOMeter.DataType type, DateTime timestamp, float[] values)
        {
            if (type == incomingDataType)
            {
                timestamps.Add(timestamp);
